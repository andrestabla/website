...
export const LB_RESOURCE_KIND_SPECS: Record<LbResourceKind, LbResourceKindSpec> = {
  ...
  PODCAST: {
    ...
    label: 'Pódcast',
    short: 'Pódcast',
    hint: 'Guion a varias voces con locución de ElevenLabs y transcripción sincronizada.',
    icon: 'Mic',
  ...
  VIDEO: {
    ...
    label: 'Video',
    short: 'Video',
    hint: 'Guion técnico por planos que sirve de storyboard y, con la pieza montada, de índice del reproductor.',
    icon: 'Clapperboard',
  ...
  ROUTE: {
    ...
    short: 'Ruta',
    hint: 'Propuesta de un curso completo en módulos y actividades, de la que se derivan los demás recursos.',
    icon: 'Route',
  ...
  IMPORT: {
    ...
    short: 'Importado',
    hint: 'SCORM o HTML existente, servido tal cual y editable texto a texto sobre el original.',
    icon: 'PackageOpen',
