...
const MODULES: Mod[] = [
  ...
  { module: 'LEARNING_BUILDER', name: 'Learning Builder', desc: 'Metabiblioteca por workspace: construye y edita recursos con las directivas de cada cliente, con IA, SCORM y enlace público.', to: '/ecosistema/learning', accent: 'from-rose-500 to-orange-500', icon: GraduationCap, tag: 'Educación' },
