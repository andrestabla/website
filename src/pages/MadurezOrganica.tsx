        ...
        <Layout>
                ...
                <div className="max-w-7xl mx-auto w-full relative z-10">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <span className="text-brand-secondary text-xs font-black uppercase tracking-[0.5em]">Protocolo 03</span>
                        </div>
                        <h1 className="text-7xl md:text-[9rem] font-black tracking-tighter leading-[0.85] text-white mb-12">
                            Madurez<br />
                            <span className="text-brand-secondary">Orgánica</span>
                        </h1>
                        <p className="text-2xl text-white/50 font-light max-w-2xl leading-relaxed border-l-4 border-brand-primary pl-10">
                            La transformación digital no es un proyecto — es un estado organizacional. Madurez Orgánica es el camino para llegar allí y quedarse.
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="mb-20">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <span className="text-xs font-black uppercase tracking-[0.4em] text-brand-primary">Modelo de Madurez</span>
                        </div>
                        <h2 className="text-5xl font-black text-slate-900 tracking-tighter mb-8">Los 5 niveles de madurez digital</h2>
                        <p className="text-xl text-slate-500 font-light max-w-2xl">Toda organización se encuentra en uno de estos niveles. Nuestra misión es llevarla al siguiente, y al siguiente, con un camino claro.</p>
                    </div>
                    <div className="flex flex-col md:flex-row gap-0 border border-slate-200">
                        {maturityLevels.map((level, i) => (
                            ...
                            >
                                ...
                                <div className={`text-sm font-black uppercase tracking-widest mb-3 ${i >= 3 ? 'text-white' : 'text-slate-900'}`}>{level.label}</div>
                                <div className={`text-xs font-light leading-relaxed ${i >= 3 ? 'text-white/60' : 'text-slate-400'}`}>{level.desc}</div>
                                {i >= 3 && (
                                    <div className="absolute top-4 right-4">
                                        <div className="text-[8px] font-black uppercase tracking-widest text-white/30">Objetivo →</div>
                                    </div>
                                )}
                            </motion.div>
                        ))}
            ...
            <section className="py-32 px-6 bg-slate-50 border-y border-slate-200">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-24">
                        <div className="flex items-center gap-4 mb-6">
                            <span className="w-12 h-1 bg-brand-primary" />
                            <span className="text-xs font-black uppercase tracking-[0.4em] text-brand-primary">4 Dimensiones de Intervención</span>
                        </div>
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start justify-between mb-10">
                                        ...
                                        <span className="text-xs font-black uppercase tracking-widest text-brand-secondary border border-brand-secondary/30 px-3 py-1">{d.level}</span>
                                    </div>
                                    <h3 className="text-2xl font-black text-slate-900 mb-4 tracking-tight">{d.title}</h3>
                                    <p className="text-slate-500 font-light leading-relaxed">{d.desc}</p>
                                </motion.div>
                            )
                        })}
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        <div>
                            <div className="flex items-center gap-4 mb-8">
                                <span className="w-12 h-1 bg-brand-primary" />
                                <span className="text-xs font-black uppercase tracking-[0.4em] text-brand-primary">Entregables</span>
                            </div>
                            <h2 className="text-5xl font-black text-slate-900 tracking-tighter mb-8">Lo que obtienes al final del protocolo</h2>
                        ...
                        <div className="bg-brand-primary p-16 text-white relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <div className="text-[10px] font-black uppercase tracking-[0.5em] text-white/30 mb-6">Duración típica del protocolo</div>
                                <div className="text-7xl font-black mb-4">6–12<br /><span className="text-4xl">meses</span></div>
                                <p className="text-white/50 font-light leading-relaxed">
                                    Según la complejidad organizacional y el delta de madurez actual. Con revisiones de estado cada 30 días.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-32 px-6 bg-slate-50 border-t border-slate-200">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
                    <div>
                        <h2 className="text-5xl font-black text-slate-900 tracking-tighter mb-4">Empieza con un diagnóstico</h2>
                        <p className="text-xl text-slate-400 font-light">45 minutos que definen tu hoja de ruta digital para los próximos 24 meses.</p>
                    </div>
