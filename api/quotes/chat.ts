...
## RESPONDE SOLO CON ESTE JSON
{
  ...
  "patch": {
    ...
    "pagesPatch": {
      ...
      "_estilo": "cualquier bloque (texto, tabla, esquema, línea de tiempo, tarjetas, fase, equipo, firma…) admite \"style\": { \"size\": \"xs|sm|md|lg|xl|xxl\", \"color\": \"ink|navy|cyan|gold|muted|white\", \"weight\": \"bold|normal\", \"bg\": \"none|soft|cyan|gold|navy\", \"italic\": true, \"uppercase\": true }; list admite \"marker\": \"number|check\"; table admite \"tableStyle\": \"default|striped|minimal|navy|compact\", \"fontSize\": \"xs|sm|md\" \"merges\": [{ \"r\": 0, \"c\": 0, \"cs\": 2, \"rs\": 1 }] (celdas combinadas: origen fila r, columna c, abarca cs columnas y rs filas) \"colWidths\": [30, null, 20] (ancho de cada columna en %, null = automático) y sombreado \"rowBg\"/\"colBg\": [\"cyan\", null] y \"cellBg\": { \"0:1\": \"gold\" } con colores soft|cyan|gold|green|rose|navy,
      "remove": ["id de página"],
